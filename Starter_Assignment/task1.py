...
def animate(i, dataList, ser):
    ...
    ax.set_yticks(np.arange(0, 101, 10))               # Set y-axis ticks every 10 units
    ax.yaxis.grid(True, linestyle='--', alpha=0.7)     # Add y-axis grid
    ax.xaxis.grid(True, linestyle='--', alpha=0.7)     # Add x-axis grid
    ax.set_title("Humidity Data")                      # Set title of figure
    ax.set_xlabel("Sample Number")                     # Set title of y axis 
    ax.set_ylabel("Humidity (%)")                      # Set title of y axis 
