...
float vel, omega_left,omega_right;
float k = 0.9;
float kp = 7;
float ki = 120;
float kd = 0.4;
    ...
    while (central.connected()) {
      ...
      //Finish bluetooth setup
        if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable()) {
          ...
          //Angular speed
          omega_left =encoderLeft.getAngularSpeed(AS5600_MODE_RPM);
          I2CMux.closeChannel(0);
          I2CMux.openChannel(1);
          omega_right =encoderRight.getAngularSpeed(AS5600_MODE_RPM);
          I2CMux.closeChannel(1);
          I2CMux.openChannel(0);
          vel =(-omega_left + omega_right)/2;//in angle/sec
